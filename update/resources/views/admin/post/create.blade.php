                    ...
                    <form onsubmit="return confirm('Are you sure you want to submit?')" action="@hasSection('id'){{ url('/bem-posts') }}/@yield('id')@else {{ url('/bem-posts') }} @endif" method="POST" enctype="multipart/form-data">
                        ...
                        @show
                             <div class="form-group">
                                ...
                                <select name="post_type"  class="form-control" required>
                                     <option value="0"> Select </option>
                                        ...
                                        <option value="footer_middle">Footer middle</option>
                                </select>
                             </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="short_discription" rows="5" id="discription" ></textarea>
                            </div>
                            <div class="form-group">
                                <label for="discription">Discription:</label>
                                <textarea class="form-control" name="discription" rows="5" id="discription" ></textarea>
                            </div>

                            <div class="form-group">
                                <label for="image">Project Image:</label>
                                <input type="file" class="form-control" name="image" multiple="" placeholder="images">
                            </div>

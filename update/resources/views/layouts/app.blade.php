...
<script>
			...
			<div class="container">
				<div class="row">
					<div class="logo-area clearfix">
						...
						<div class="col-xs-12 col-md-7 header-right header_menu">
							@guest
							...
							<ul class="top-info-box">
								<li class="notifications">
									<a href="{{ url('notifications') }}" class="dropdown-toggle"  >
	...
	<div class="elfsight-app-46a942b5-cbea-4fe8-a4d4-668ba8ad401c"></div>

                          ...
                          <form method="POST" action="" enctype="multipart/form-data" onsubmit="return confirm('Do you really want to submit?');">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="hidden" value="withdrawal" name="trans_type">

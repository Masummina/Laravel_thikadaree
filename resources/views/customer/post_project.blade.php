         ...
         <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<p class="hint-text">Post your Project. It's free and only takes a minute.</p>
					...
					<div class="form-group">
						<div class="form-group">
							...
							<label class="form-check-label">
								<input type="radio" id="supplier" value="quototion" class="form-check-input" name="request_type" required> BID/Quototion
							</label>
							<label class="form-check-label">
								<input type="radio" id="contructor" value="proposal" class="form-check-input" name="request_type"> EOI/Proposal
							</label>
						</div>
					</div>
					...
					<div class="loaction">
						 <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Location" id="joblocatio" name="joblocation">
                        </div>

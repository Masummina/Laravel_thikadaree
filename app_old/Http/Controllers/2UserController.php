...
class UserController extends Controller
{
    ...
    public function index()
    {
		...
		->select('projects.id','projects.joblocatio','projects.title','projects.status','projects.close_date','projects.prebit_meeting','projects.min_budget','projects.max_budget','projects.created_at','bids.money','bids.created_at as biddate','bids.days')
		...
		->Join('bids', 'projects.id', '=', 'bids.project_id')
		->select('projects.id','projects.joblocatio','projects.title','projects.status','projects.close_date','projects.prebit_meeting','projects.min_budget','projects.max_budget','projects.created_at','projects.status','bids.money','bids.created_at as biddate','bids.days')
		->where('bids.user_id', $user_id)
		->where('bids.win', 1)

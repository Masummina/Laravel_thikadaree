            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group budget">
						<label for="project_budget">Estimated budget:</label><br>
							<select class="browser-default custom-select" id="estimatedbudget" name="project_budget" onchange="estimatedBudget()" required>
								<option value="" selected>Select Your budget</option>
								@if(isset($budget))
									@foreach($budget as $projectdudget)
									<option value="{!! $projectdudget->id.'-'.$projectdudget->budget_range !!}">
										{!! @$projectdudget->title !!} -  
										{!! @$projectdudget->title_bn !!} - 
										({!! @$projectdudget->budget_range !!})
									</option>
									@endforeach
								@endif
							</select>
							<div id="estimated_alert">
 			...
 			var item_element = ' '+
					'<div class="bid_quototion" >'+
						'<div class="form-group">'+
							...
							'<input type="text" class="form-control" placeholder="item title" id="item" name="item[]">'+
						'</div>'+
						'<div class="form-group">'+
						...
						'<div class="form-group">'+
							...
							'<input type="number" class="form-control" placeholder="quantity" name="quo_quantity">'+
						'</div>'+

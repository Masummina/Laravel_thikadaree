								  ...
								  @endphp
					               	<li>
					                    <div class="posts-thumb pull-left"> 
					                    		<a href="{{url('jobs')}}/{{$seo_title}}"><img alt="img" src="images/upload/{!! $value->images !!}"></a>
					                    </div>
					                    <div class="post-info">
					                        <h4 class="entry-title">
					                        	<a href="{{url('jobs')}}/{{$seo_title}}">{!! $value->title !!}</a>
					                        </h4>
					                    </div>
							...
							<div class="left-content">
                               ...
                               @php									
		                        ...
		                        {!! $val->title !!}
									...
									<p class="ArticleBody">{{ substr($val->discription, 0, 180) }}
										{{ strlen($val->discription) > 180 ? "..." : "" }}
									</p>
		                        <div class="open-status">
		                          <div class="open op-st">
		                            <p class="con"><img src="{!! asset ('images/project/open.png') !!}"><span class="op-close">Open</span> less then a minute age - <span class="bids">  cc  bids</span></p>
		                          </div>

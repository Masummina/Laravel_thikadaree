      ...
      <div class="row"> <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="clearfix">
                        @php
                            $target_year = DB::table('targets')->select('year')->groupBy('year')->orderBy('year','desc')->get();
                        ...
                        <form method="get" class="pull-left form-inline my-2 my-lg-0" action="">
                            ...
                            <select name="year" class="form-control" id="exampleSelect1" onchange="this.form.submit()" >
                         ...
                         @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                @for($j=1; $j<=12; $j++)
                                    ...
                                    @endif
                                    @php $target_td .= '<td style="text-align: center; color:#000;">'.$amount_link.'</td>'; @endphp
                                @endfor

                                ...
                                <div class="box-body">
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        @if($payment_schedules_list)
                                            ...
                                            @endforeach
                                                <tr>
                                                    <td colspan="3" style="text-align: center"><strong>Total Price : </strong> {!! number_format($account_info->purchase_price,2) !!} </td>
                                                    <td colspan="2">  </td>
                                                    <td colspan="2" style="border-right: none"><strong>Total Paid : </strong> {!! number_format($totalPaid,2) !!} </td>

                                                    @if(isset($_GET['type']) && $_GET['type']=='rebate')
                                                        <td >  </td>
                                                        <td > {!! number_format($totalRebate,2) !!} </td>
                                                    @elseif(isset($_GET['type']) && $_GET['type']=='delay')
                                                        <td >  </td>
                                                        <td > {!! number_format($totalDelay,2) !!} </td>
                                                    @endif
                                                </tr>
                                                <tr>
                                                    <td colspan="5">  </td>
                                                    <td colspan="3" style="border-right: none"><strong>Balance : </strong> @php $balance = $account_info->purchase_price - $totalPaid @endphp {!! number_format($balance,2) !!} </td>
                                                    @if(isset($_GET['type']) && $_GET['type']=='rebate')
                                                        <td colspan="2"></td>
                                                    @elseif(isset($_GET['type']) && $_GET['type']=='delay')
                                                        <td colspan="2"></td>

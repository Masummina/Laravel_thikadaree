                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td> {!! date("j M Y", strtotime($schedules_info->created_at)) !!} </td>
                            <td style="text-align:right;"> {!! number_format($schedules_info->earnest_money) !!} </td>                                                   
                            <td> -- </td>
                            <td> -- </td>
                            <td> -- </td>
                            <td> -- </td>                        
                        ...
                        <tr>
                            ...
                            <td> {!! date("j M Y", strtotime($schedules_info->created_at)) !!} </td>
                            <td style="text-align:right;"> {!! number_format($down_payment) !!}   </td>                                                        
                            <td> -- </td>
                            <td> -- </td>
                            <td> -- </td>
                            <td> -- </td>
                        ...
                        @if($no_of_month>0)
                            @while($date_end>$date_start)
                                @php 
                                    ...
                                    // echo $Advance_deposit_total." --- ".$per_month_installment;  exit;

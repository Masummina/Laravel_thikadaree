                ...
                @while($date_end>$date_start)
                    @php 
                        ...
                        if($Advance_deposit_total > $per_month_installment)
                        {
                            ...
                            $Advance_Days = 0;  $After_Days = 0;
                            $Rebate = 0;        $Delay_Charge = 0;
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;"> {!! $After_Days !!}  </td>                                            
                            ...
                            {                                          
                                ...
                                if($schedule_date<$payment_date){
                                    $After_Days = get_days_diff($payment_date,$schedule_date);                                                
                                    $Delay_Charge = ((($Second_Payment*$delay_rate)/100)/365)*$After_Days;
                                    $Delay_Charge_Total += $Delay_Charge;
                                } else {
                                    $Advance_Days = get_days_diff($schedule_date,$payment_date);
                                    $Rebate = ((($Second_Payment*$rebateRate)/100)/365)*$Advance_Days;
                                    $Rebate_Total += $Rebate;
                                }
                                ...
                                if($rest_installment > 1) 
                                {
                                    //echo $per_month_installment.' -- '.$deposit_total;

                                    echo (int)$per_month_installment; echo "<br/>";
                                    echo (int)$deposit_total; echo "<br/>";

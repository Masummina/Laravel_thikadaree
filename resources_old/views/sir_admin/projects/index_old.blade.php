            ...
            @endif
              ...
              @endforeach
                ...
                <div class="box-header">
                  ...
                  <div class="project-header" style="font-size: 18px; float:left; margin-left:10px ">
                    ...
                    Forthcoming : <a href="{!! url('project?action=forthcoming') !!}"> <i class="btn btn-danger"> {!! count($forthcoming) !!} </i> </a>
                    Sold : <a href="{!! url('project?action=sold') !!}"> <i class="btn btn-danger"> {!! $totalSold !!} </i> </a>
                    Unsold : <a href="{!! url('project?action=unsold') !!}"> <i class="btn btn-danger"> {!! $unsold !!} </i> </a>
                  </div>
                  <p class="pull-right">

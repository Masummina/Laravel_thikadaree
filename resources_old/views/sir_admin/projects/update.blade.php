            ...
            {{Form::open(array('url'=>'project/update/'.$project->id,'method'=>'post', 'class'=>'form-horizontal'))}}
              ...
              @endif
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                     <select class="form-control" name="type">
                         ...
                         <option <?php if($project->type == 'Common Facilities'){ echo 'selected' ; } ?>  value="Common Facilities">Common Facilities</option>
                         <option <?php if($project->type == 'Community Hall'){ echo 'selected' ; } ?>  value="Community Hall">Community Hall</option>
                     </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{!!$project->land!!}" type="text" name="land" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{!!$project->building!!}" type="text" name="building" placeholder="Building ( storage)" class="form-control" id="title">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{!!$project->landmarking!!}" type="text" name="landmarking" placeholder="Landmarking" class="form-control" id="title">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{!!$project->hand_over!!}" type="date" name="hand_over" placeholder="Hand over" class="form-control" id="title">
                        </div>
                    </div>
                <div class="form-group">

                  ...
                  <form id="advanced_s" method="get" class="  form-inline my-2 my-lg-0" action="">
                      ...
                      <div class="row mt-1">
                          <div class="col-sm-8">
                              ...
                              <input type="text" name="customer_name" value="{{@$_GET['customer_name']}}" minlength="4" style="width: 120px">
                              <span class="report-headline"> Mobile : </span>
                              <input type="text" name="customer_mobile" value="{{@$_GET['customer_mobile']}}" minlength="5" style="width: 100px" >
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">
                  <div class="row clearfix">
                      ...
                      @endphp
                      <div class="prospect-header" style="font-size: 18px; float:left; margin-left:10px ">
                      ...
                      <table class="table  table-fixed">
                          ...
                          <tr>
                              ...
                              @if(\Auth::user()->group_id==1)
                                <th style="width: 10%; float: left">Team M.  </th>   
                                <th style="width: 10%; float: left"> Project </th>
                              @else 
                                <th style="width: 20%; float: left"> Project </th>                              
                              @endif 
                          ...
                          @foreach($customer_list as $row)
                                  ...
                                  @php
                                      ...
                                      $CID = substr($CID,1,7);
                                        ...
                                        if(isset($activities[0]->project_name) && $activities[0]->project_name!=''){
                                            $project_name_c = $activities[0]->project_name;
                                        } else if($c_info->area_of_interest!='') {
                                            $project_name_c = $c_info->area_of_interest;
                                        } else {
                                            $project_name_c = '--';
                                        }
                              ...
                              <tr>
                                  ...
                                  <td style="width: 12%; float: left">{{ $row->mobile }} </td>
                                    ...
                                    @if(\Auth::user()->group_id==1)
                                        ...
                                        <td style="width: 10%; float: left"> {!! $project_name_c !!} </td>
                                    @else 
                                        <td style="width: 20%; float: left"> {!! $project_name_c !!} </td>                                           
                                    @endif

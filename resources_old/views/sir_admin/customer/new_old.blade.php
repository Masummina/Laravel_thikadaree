...
@section('content')
    ...
    <script type="text/javascript" src="/js/add-child.js"></script>
               ...
               <form id="master_div" class="form-horizontal" onsubmit="return confirm('Are you sure you want to submit?')" action="@hasSection('customer_id'){{ url('submit-user') }}@else {{ url('customers') }} @endif" method="POST">
                    ...
                    <div id="ContactBlock" class="card-body">
                      ...
                      <div class="input-group input-group-sm">
                          ...
                          <input style="width: 45px" name="prefix" placeholder="Prefix" class="form-control" value="@yield('prefix')">
                          <input name="name" value="@yield('name')" placeholder="name" class="form-control" required>

                          <span class="input-group-addon">Status</span>
                          <select id="type" name="type" class="form-control">
                              <option @if(isset($customer->type)=='Prospect')selected @endif value="Prospect">Prospect</option>
                              <option @if(isset($customer->type)=='Client')selected @endif value="Client">Client</option>
                             
                          </select>
                      </div>
                      <div class="input-group input-group-sm">
                          <span class="input-group-addon">Mobile</span>
                          <input name="mobile" value="@yield('mobile')" placeholder="Mobile " class="form-control " required >
                      ...
                      <div class="input-group input-group-sm">
                          ...
                          <input name="district" value="@yield('home_district')" placeholder="District" list="datalistDistrict" class="form-control ">
                          <span class="input-group-addon">Country</span>
                          <input name="country" value="@yield('country')" placeholder="Country" class="form-control ">
                      </div>
                      <div class="input-group input-group-sm">
                   ...
                   @if(isset($activities))
                    ...
                    <div  id="PersonalBlock" class="card-body">
                        ...
                        <div class="input-group">
                            ...
                            @endif
                            <span class="input-group-addon"> Property </span>
                            <select name="property_id" id="property_id" class=" form-control"><option value=""> Select Property </option></select>
                            
                            <span class="input-group-addon"> Contact Method </span>
                            @php $contact_methods = array('Phone Call','Visit to Office','Visit to Project','Internal Visit','Both','Visit to Home'); @endphp
                            ...
                            @php $lead_status = array('Primary','Secondary','Near to Close','DOL','BFO','Dead'); @endphp
                    ...
                    <div id="area_of_interest" class="card-body">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input name="area_name" value="@yield('area_of_interest')" placeholder="Area of Interest " class="form-control ">
 ...
 <div class="input-group input-group-sm">           <span class="input-group-addon">Name of Child</span>           <input name="c_prefix[]" type="text" value="{!!$row->prefix !!}" placeholder="Prefix" class="form-control">            <input name="c_name[]" type="text" placeholder="name" value="{!!$row->name !!}" class="form-control" required="">
                 <span class="input-group-addon">Date of Birth</span>                  <input name="c_dob[]" value="{!!$row->dob !!}" type="date" class="form-control col-md-2"><br>
</div>
<div class="input-group input-group-sm">        <span class="input-group-addon">Interests</span>        <input name="c_interest[]" type="text" value="{!!$row->interest_01 !!}" placeholder="Interests" class="form-control input-personal">        <span class="input-group-addon"> Food Habits </span>        <input name="c_foodhabits[]" value="{!!$row->food_habit !!}" type="text" placeholder="Food Habits" class="form-control input-personal">        <span class="input-group-addon"> Health Info</span>        <input name="c_health_info[]" value="{!!$row->health_info !!}" type="text" placeholder="Health Info " class="form-control input-personal"></div><button type="submit" name="rmv" id=" 1 " class="btn btn-warning remove-child">Remove</button>        </div>
@endforeach
@endif
@endif

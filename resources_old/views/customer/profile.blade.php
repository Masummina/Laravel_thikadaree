            ...
            <div class="row">
                <div class="col-md-3 col-sm-3">
                    ...
                    <div class="profile_info">
                         <p class="gmail"><i class="fa fa-envelope" aria-hidden="true"></i> Email: {{ Auth::user()->email }}</p>
                            <p class="mobile">
                                <i class="fa fa-phone" aria-hidden="true"></i>Phone: 
                                {!! @$userPro->mobile !!}
                        </p>
                        <p class="mobile">Skills:  <span>{!! @$userPro->skills !!}</span></p>
                ...
                <div class="col-md-9 col-sm-9 profile_right">
                    ...
                    <div class="bid_post">
                        <p class="Jobs pull-left"><b>Jobs Completed: </b> <span> 20</span></p>
                         <p class="posts pull-right"><b>Jobs Completed: </b> <span> 20</span></p>
                    </div>
                    </div>
